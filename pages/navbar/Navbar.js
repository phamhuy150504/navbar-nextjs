...
export default function Navbar() {
  return (
    ...
    <div className="container flex flex-wrap items-center justify-between mx-auto">
        <a href="https://ecosmart.netlify.app/" className="flex items-center ">
            <img src="https://ecosmart.netlify.app/static/img/aboutus/logo.png" className="h-10 mr-3" alt="Eco Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Eco-Mart</span>
        </a>
